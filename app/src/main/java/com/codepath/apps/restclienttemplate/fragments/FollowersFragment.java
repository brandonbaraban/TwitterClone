...
public class FollowersFragment extends FollowFragment {
    ...
    public static FollowersFragment newInstance(String screenName){
        FollowersFragment followFragment = new FollowersFragment();
...
//    }
    ...
    private void fetchFollowers(long page) {
        showProgressBar();
        ...
        client.getFollowers(params, new JsonHttpResponseHandler() {
            @Override
